...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pybdv-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11678&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pybdv-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pybdv` can be installed with:

```
conda install pybdv
```

It is possible to list all of the versions of `pybdv` available on your platform with:
